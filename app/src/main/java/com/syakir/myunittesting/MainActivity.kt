...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        ...
        when {
            length.isEmpty() -> edt_length.error = "Field ini harus diisi"
            width.isEmpty() -> edt_width.error = "Field ini harus diisi"
            height.isEmpty() -> edt_height.error = "Field ini harus diisi"
            else -> {
                ...
                when {
                    ...
                    v.id == R.id.btn_calculate_surface_area -> {
                        tv_result.text = mainViewModel.getSurfaceAre().toString()
                        gone()
                    }
